        ...
        <div id="container"> <!-- On ouvre le contener principal -->
            <div id="top"> <!-- On ouvre le top -->
                ...
                <div id="content"> <!-- Contenu quelconque -->
                    <div id="path"><a href="index.php">Home</a> <img src="img/next.png" alt=""> <a href="news.php">News</a> <img src="img/next.png" alt=""> <a href=""><span>14-07-2013</span></a></div>
                        ...
                        <div id="article-content">
                            ...
                            <div id="share-article">
                                    ...
                                    <div id="tooltip-article" class="tooltip">
                                        <span>SHARE</span>
                                        <!--  --><a href="http://twitter.com/home?status=<?php echo $html; ?>+<?php echo curPageURL(); ?>" target="_blank"><div id="share-twitter">Twitter</div></a>
                                        <!--  --><a href="http://www.facebook.com/share.php?u=<?php echo curPageURL(); ?>&title=<?php echo $html; ?>" target="_blank"><div id="share-facebook">Facebook</div></a>
                                        <!--  --><a href="http://pinterest.com/pin/create/bookmarklet/?media=<?php echo $articleImgSrc; ?>&url=<?php echo curPageURL(); ?>&is_video=false&description=<?php echo $html; ?>" target="_blank"><div id="share-pinterest">Pinterest</div></a>
                                        <!--  --><a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo curPageURL(); ?>&title=<?php echo $html; ?>&source=Col&MacArthur" target="_blank"><div id="share-linkedin">LinkedIn</div></a>
                            ...
                            <div id="article-writer">
                                By Sebastien Colen posted July 14th, 2013 at 07:16 PM
                            </div>

                            <div id="article-text">
                                As most of you will have noticed, the dial insignia is very slightly larger than the 2012 model we posted on <a href="https://www.facebook.com/scotsguards.watch" target="_blank">Facebook</a>. This watch is after all, a Scots Guards watch and as such, the badge should be the dominant feature; easier to admire while being composed of 200 micro-dots per mm2 with a protective surface to resist UV and fading.<br><br>
                                As it stands today, we believe that customer satisfaction will obviously be achieved as our thanks must go out to well over 100 volunteers who provided us with assistance and points of view that now makes this dial what it is today; the focal-point for the Brigade of Guards. 
                            </div>

                            <div id="article-img">
                                <img id="article-img-src" src="img/article-140713.jpg" alt="">
                            </div>
