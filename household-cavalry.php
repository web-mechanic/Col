...
<html>
    <head>
        ...
        <title>The Household Cavalry Watch</title>
        ...
        <div id="container"> <!-- On ouvre le contener principal -->
            <div id="top"> <!-- On ouvre le top -->
                ...
                <div id="content"> <!-- Contenu quelconque -->
                    <div id="path"><a href="index.php">Home</a> <img src="img/next.png" alt=""> <a href="household-cavalry.php"><span>Household Cavalry Watch</span></a></div>
                    ...
                    <div id="sg-watch-container">
                        <div id="sg-watch-img">
                            ...
                            <a href="img/hc-photo-big.jpg" id="zoom01" class="cloud-zoom" rel="position:'right', zoomWidth:448, zoomHeight:422, adjustX:59, adjustY:0, tint:'#050505', softFocus:1, smoothMove:5, tintOpacity:0.5">
                            <img src="img/hc-watch-2.png"></a>
                        </div>
                        <div id="sg-watch-img-print"></div>
                        <div id="cadre-print"></div>
                        <div id="hc-watch-content">
                            <h1>Your Regimental Watch</h1>
                            <h2>THE HOUSEHOLD CAVALRY WATCH</h2>
                        ...
                        <!--  --><a href="http://twitter.com/home?status=The Household Cavalry Watch+<?php echo curPageURL(); ?>" target="_blank"><div id="share-twitter">Twitter</div></a>
                        <!--  --><a href="http://www.facebook.com/share.php?u=<?php echo curPageURL(); ?>&title=The Household Cavalry Watch" target="_blank"><div id="share-facebook">Facebook</div></a>
                        <!--  --><a href="http://pinterest.com/pin/create/bookmarklet/?media=http://colandmacarthur.com/img/hc-photo-big.jpg&url=<?php echo curPageURL(); ?>&is_video=false&description=The Household Cavalry Watch" target="_blank"><div id="share-pinterest">Pinterest</div></a>
                        <!--  --><a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo curPageURL(); ?>&title=The Household Cavalry Watch&source=Col&MacArthur" target="_blank"><div id="share-linkedin">LinkedIn</div></a>
                        <!--  --><a href="https://plus.google.com/share?url=<?php echo curPageURL(); ?>" target="_blank"><div id="share-googleplus">Google+</div></a>
                        <a href="mailto:?subject=The Household Cavalry Watch&body=http://www.colandmacarthur.com/household-cavalry.php"><div id="share-email">Email</div></a>
                            </div>
                            <span>SHARE</span>
                            ...
                            <div id="clear"></div>
                            <div id="gallery">
                                <a href="img/hc-watch-perspective.jpg" data-lightbox="image-1" ><img src="img/hc-watch-perspective-small.jpg" alt="" onmouseover="this.src='img/hc-watch-perspective-small-hover.jpg'" onmouseout="this.src='img/hc-watch-perspective-small.jpg'"></a>
                                <a href="img/hc-watch-front.jpg" data-lightbox="image-1" ><img src="img/hc-watch-front-small.jpg" alt="" onmouseover="this.src='img/hc-watch-front-small-hover.jpg'" onmouseout="this.src='img/hc-watch-front-small.jpg'"></a>
                                <a href="img/hc-watch-back.jpg" data-lightbox="image-1" ><img src="img/sg-watch-back-small.jpg" alt="" onmouseover="this.src='img/sg-watch-back-small-hover.jpg'" onmouseout="this.src='img/sg-watch-back-small.jpg'"></a>
                                ...
                                <a href="img/hc-watch-case.jpg" data-lightbox="image-1" ><img src="img/hc-watch-case-small.jpg" alt="" onmouseover="this.src='img/hc-watch-case-small-hover.jpg'" onmouseout="this.src='img/hc-watch-case-small.jpg'"></a>
